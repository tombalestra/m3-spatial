...
class _RenderGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        conic_opacity,
        rgb,
        emb, # NOTE XYZ: Learnable Feature
        depths,
        radii,
        compute_locally,
        extended_compute_locally,
        ...
        # NOTE XYZ: Learnable Feature
        num_rendered, color, embedings, n_render, n_consider, n_contrib, geomBuffer, binningBuffer, imgBuffer = _C.render_gaussians(*args)    
        ...
        ctx.save_for_backward(means2D, conic_opacity, rgb, emb, geomBuffer, binningBuffer, imgBuffer, compute_locally, extended_compute_locally) # NOTE XYZ: Learnable Feature
        ctx.mark_non_differentiable(n_render, n_consider, n_contrib) # NOTE XYZ: Learnable Feature
        return color, embedings, n_render, n_consider, n_contrib

    @staticmethod
    def backward(ctx, grad_color, grad_embeddings, grad_n_render, grad_n_consider, grad_n_contrib):
        ...
        # NOTE XYZ: Learnable Feature
        means2D, conic_opacity, rgb, emb, geomBuffer, binningBuffer, imgBuffer, compute_locally, extended_compute_locally = ctx.saved_tensors
        ...
        dL_dmeans2D, dL_dconic_opacity, dL_dcolors, dL_dembeddings = _C.render_gaussians_backward(*args) # NOTE XYZ: Learnable Feature
        ...
        grads = (
            ...
            dL_dembeddings.contiguous(), # NOTE XYZ: Learnable Feature
            None,
            None,
            None,
            None,
...
class GaussianRasterizer(nn.Module):
    ...
    def render_gaussians(self, means2D, conic_opacity, rgb, emb, depths, radii, compute_locally, extended_compute_locally, cuda_args = None):
