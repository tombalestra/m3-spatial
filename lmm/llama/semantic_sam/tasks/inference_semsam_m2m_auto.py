...
def inference_semsam_m2m_auto(model, image, level, image_size, label_mode='1', alpha=0.1, anno_mode=['Mask']):
    t = []
    t.append(transforms.Resize(int(image_size), interpolation=Image.BICUBIC))
