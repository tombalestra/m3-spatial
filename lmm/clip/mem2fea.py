...
if __name__ == "__main__":
    ...
    all_embeddings, all_image_pths = load_clip_embeddings(data_root, device)
    
    # 0.7, 0.75, 0.8, 0.85, 0.90
    threshold = 0.7
    mem_path = os.path.join(data_root, "clip", f"mem{int(threshold*100)}.emb")
    ...
    mem2fea_path = os.path.join(data_root, "clip", f"mem{int(threshold*100)}.index")
