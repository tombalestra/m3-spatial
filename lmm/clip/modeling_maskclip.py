...
from .utils import interpolate_positional_embedding
...
class CLIP(nn.Module):
    ...
    def forward(self, image, text):
        image_features, pixel_features = self.encode_image(image)
        ...
        logits_per_pixel = logit_scale * pixel_features @ text_features.t()
        
        # shape = [global_batch_size, global_batch_size]
        return logits_per_image, logits_per_text, logits_per_pixel
