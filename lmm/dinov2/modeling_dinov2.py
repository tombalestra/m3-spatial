...
class Dinov2Embeddings(nn.Module):
    ...
    def __init__(self, config: Dinov2Config) -> None:
        ...
        self.cls_token = nn.Parameter(torch.randn(1, 1, config.hidden_size)) # [1, 1, 768]
        self.mask_token = nn.Parameter(torch.zeros(1, config.hidden_size)) # [1, 768]
        self.patch_embeddings = Dinov2PatchEmbeddings(config) #  Conv2d(3, 768, kernel_size=(14, 14), stride=(14, 14))
