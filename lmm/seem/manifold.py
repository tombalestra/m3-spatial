...
def load_seem_embeddings(data_root):
...
def visualize_umap(embeddings, output_file):
    ...
    plt.title("UMAP Visualization of SEEM Embeddings (Continuous Colormap)")
...
if __name__ == "__main__":
    ...
    output_file = "seem_umap_embeddings_continuous.png"
    
    print("Loading SEEM embeddings...")
    all_embeddings = load_seem_embeddings(data_root)
